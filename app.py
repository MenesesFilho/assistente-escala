...
# Usa o projeto correto para evitar 404 "No assistant found"
...
def wait_for_run(thread_id: str, run_id: str, timeout_s: int = 900):
    ...
    while True:
        ...
        time.sleep(2.0)  # polling mais espaçado para reduzir carga/memória
