...
def gerar_escala(modelo_bytes, vendas_dia_bytes, vendas_hora_bytes,
    ...
    pre_open = abertura - 1
    post_close = fechamento  # cobertura até fechamento+1 é parte do turno, mas visual do T3 vai até fechamento
    ...
    info_map = {
        ...
        "Observações": "Regras: 1h pré-abertura; 1h pós-fechamento; base 2 em operação (1 no menor pico); papéis fixos; 44h/semana (4x9h+1x8h); folgas 5x2 seg-sex; 2 no fechamento."
    }
